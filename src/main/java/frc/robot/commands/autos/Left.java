...
public class Left extends SequentialCommandGroup {
    ...
    public Left(SwerveSubsystem s, ElevatorSubsystem e, CoralizerSubsystem c, DistanceSubsystem d, CameraSubsystem ca) {
        ...
        addCommands(
                ...
                Commands.parallel(
                        new PathToCommand(() -> MathHelper.offsetPoseReverse(FieldOrientation.getOrientation().getReefL(), (Constants.BluePositions.cRobotLength / 2) + 0.35), 0.1, alignConstraints, s),
                        new ElevatorPositionCommand(e, Constants.Elevator.L4Height, ReefPosition.ReefLevel.L4),
                        new CoralizerWristCommand(c, Constants.Elevator.L4Angle)
                ),
